...
class GameLevelManager : cocos2d::CCNode {
	...
	void onDeleteServerLevelListCompleted(gd::string, gd::string);
	...
	void onUploadLevelListCompleted(gd::string, gd::string);
